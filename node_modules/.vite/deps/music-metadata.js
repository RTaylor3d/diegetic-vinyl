...
import {
  TrackType
} from "./chunk-UGFZXDRK.js";
import {
  hasID3v1Header
} from "./chunk-6FIYPJ5U.js";
import {
  APEv2Parser
} from "./chunk-EFGVHNYZ.js";
import "./chunk-KQR6CSWM.js";
import {
  fromBuffer,
  fromWebStream
} from "./chunk-BRRRQODI.js";
import {
  LyricsContentType,
  TimestampFormat
} from "./chunk-4EMSWI37.js";
import {
  decodeString,
  getUintBE,
  includes,
...
var mpegParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MpegParser-6ZYXCY4N.js")).MpegParser(metadata, tokenizer, options);
  }
};
...
var apeParserLoader = {
  ...
  extensions: [".ape"],
  async load(metadata, tokenizer, options) {
    return new (await import("./APEv2Parser-TDWTACUW.js")).APEv2Parser(metadata, tokenizer, options);
  }
};
...
var asfParserLoader = {
  ...
  extensions: [".asf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./AsfParser-4WRTUQJ3.js")).AsfParser(metadata, tokenizer, options);
  }
};
...
var dsdiffParserLoader = {
  ...
  extensions: [".dff"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsdiffParser-C5X3463K.js")).DsdiffParser(metadata, tokenizer, options);
  }
};
...
var aiffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./AiffParser-JCGQOWDG.js")).AIFFParser(metadata, tokenizer, options);
  }
};
...
var dsfParserLoader = {
  ...
  extensions: [".dsf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsfParser-Q3MVU66W.js")).DsfParser(metadata, tokenizer, options);
  }
};
...
var flacParserLoader = {
  ...
  extensions: [".flac"],
  async load(metadata, tokenizer, options) {
    return new (await import("./FlacParser-BAJAT5IS.js")).FlacParser(metadata, tokenizer, options);
  }
};
...
var matroskaParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MatroskaParser-AAC4DHFV.js")).MatroskaParser(metadata, tokenizer, options);
  }
};
...
var mp4ParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MP4Parser-CNR5VRJ4.js")).MP4Parser(metadata, tokenizer, options);
  }
};
...
var musepackParserLoader = {
  ...
  extensions: [".mpc"],
  async load(metadata, tokenizer, options) {
    return new (await import("./MusepackParser-2JXSAQJQ.js")).MusepackParser(metadata, tokenizer, options);
  }
};
...
var oggParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./OggParser-HL6DGIRF.js")).OggParser(metadata, tokenizer, options);
  }
};
...
var wavpackParserLoader = {
  ...
  extensions: [".wv", ".wvp"],
  async load(metadata, tokenizer, options) {
    return new (await import("./WavPackParser-MN44CXYG.js")).WavPackParser(metadata, tokenizer, options);
  }
};
...
var riffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./WaveParser-FWB6WXB4.js")).WaveParser(metadata, tokenizer, options);
  }
};
