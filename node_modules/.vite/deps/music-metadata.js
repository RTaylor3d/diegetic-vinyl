...
import {
  hasID3v1Header
} from "./chunk-JY43VHIE.js";
import {
  APEv2Parser
} from "./chunk-WYFIYUF3.js";
...
var mpegParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MpegParser-6F745AE3.js")).MpegParser(metadata, tokenizer, options);
  }
};
...
var apeParserLoader = {
  ...
  extensions: [".ape"],
  async load(metadata, tokenizer, options) {
    return new (await import("./APEv2Parser-H7KXJ5Q3.js")).APEv2Parser(metadata, tokenizer, options);
  }
};
...
var asfParserLoader = {
  ...
  extensions: [".asf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./AsfParser-EKIKJVHQ.js")).AsfParser(metadata, tokenizer, options);
  }
};
...
var dsdiffParserLoader = {
  ...
  extensions: [".dff"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsdiffParser-JUWYDPVB.js")).DsdiffParser(metadata, tokenizer, options);
  }
};
...
var aiffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./AiffParser-MRA7L5VG.js")).AIFFParser(metadata, tokenizer, options);
  }
};
...
var dsfParserLoader = {
  ...
  extensions: [".dsf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsfParser-TDNEVW2E.js")).DsfParser(metadata, tokenizer, options);
  }
};
...
var flacParserLoader = {
  ...
  extensions: [".flac"],
  async load(metadata, tokenizer, options) {
    return new (await import("./FlacParser-EGIVIBO6.js")).FlacParser(metadata, tokenizer, options);
  }
};
...
var mp4ParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MP4Parser-WJHUTMHU.js")).MP4Parser(metadata, tokenizer, options);
  }
};
...
var musepackParserLoader = {
  ...
  extensions: [".mpc"],
  async load(metadata, tokenizer, options) {
    return new (await import("./MusepackParser-VBBQHQET.js")).MusepackParser(metadata, tokenizer, options);
  }
};
...
var oggParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./OggParser-YJ3SRVCR.js")).OggParser(metadata, tokenizer, options);
  }
};
...
var wavpackParserLoader = {
  ...
  extensions: [".wv", ".wvp"],
  async load(metadata, tokenizer, options) {
    return new (await import("./WavPackParser-4WQPAYHS.js")).WavPackParser(metadata, tokenizer, options);
  }
};
...
var riffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./WaveParser-J6TLDVZL.js")).WaveParser(metadata, tokenizer, options);
  }
};
